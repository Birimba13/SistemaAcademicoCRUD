...
type
  TFormMatriculasMain = class(TForm)
    ...
    pFormMatriculasPT3: TPanel;
    bFormMatriculasPT3Salvar: TButton;
    bFormMatriculasPT3Adicionar: TButton;
...
var
  FormMatriculasMain: TFormMatriculasMain;
